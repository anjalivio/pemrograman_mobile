...
class _GantiWarnaPageState extends State<GantiWarnaPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: _isBlue ? Colors.greenAccent[100] : Colors.yellowAccent[100],
      appBar: AppBar(
        title: const Text('Ubah Warna'),
        backgroundColor: _isBlue ? Colors.greenAccent : Colors.yellowAccent,
      ),
      body: Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Text(
              _isBlue ? 'Warna Hijau' : 'Warna Kuning',
              style: TextStyle(
                fontSize: 24,
                color: _isBlue ? Colors.greenAccent[900] : Colors.yellowAccent[900],
